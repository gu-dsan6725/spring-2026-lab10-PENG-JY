"""
Simple Strands Agent with DuckDuckGo Search, Weather, Directions, Time, and Currency tools.
...
def _create_agent() -> Agent:
    ...
    """
    logger.info("Creating Strands agent with search, weather, directions, time, and currency tools")
